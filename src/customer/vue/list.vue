<template>
  <div>
    <header id="header" class="mui-bar mui-bar-nav" style="position: fixed">
      ...
      <a class="mui-icon-plusempty mui-icon mui-pull-right" @click="add()"></a>
      <a class="mui-icon-search mui-icon mui-pull-right" style="right: 18px;" @click="search()"></a>
    </header>
        ...
        <mui-scroll-refresh bottom="0" top="108px">
          <div class="list_customer sideline_up sideline_down" v-for="list in listData.dataList"
            ...
            <div class="content mui-icon mui-push-right">
              ...
              <span
                v-text="cutArr[0].itemCode==0?toDate(list.lastOperatedOn):(cutArr[0].itemCode==3?list.createdOn:('¥' + list.forecastAmount))"
                :class="{'red': cutArr[0].itemCode==2}"></span>
            </div>
