...
(function (global, factory) {
  ...
  /**
   * Swap the element at the given main with a new value
  ...
  /**
   * Convenience method to remove the element at given main.
   *
   * @param {Number} main
   * @param {*} val
   */
   ...
   * @return {String} - placeholder with main
   */
   ...
   *
   * @param {String} str
   * @param {String} i - matched save main
   * @return {String}
   */
  ...
  var vFor = {
    ...
    diff: function diff(data) {
      ...
      for (i = 0, l = frags.length; i < l; i++) {
        ...
        if (frag.reused && !frag.staggerCb) {
          ...
          // insert with updated stagger main.
    ...
    /**
     * Get a cached fragment from the value/main/key
     *
     * @param {*} value
     * @param {Number} index
     * @param {String} key
  ...
  function stateMixin (Vue) {
    ...
    /**
     * Initialize meta information like $main, $key & $value.
     */
