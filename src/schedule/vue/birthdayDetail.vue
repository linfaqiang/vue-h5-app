    ...
    <div class="activity_detail" style="padding-top: 44px">
      ...
      <div class="content">
        <ul>
          ...
          <li>
            <label class="detail-name">日期</label>
          ...
          <li>
            <label class="detail-name">客户</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goEdit: function (id) {
        var self = this;
        store.scheduleEdit(id, 'edit', function () {
          self.$router.go('/birthdayEdit');
        });
      }
    },
    ready: function () {
